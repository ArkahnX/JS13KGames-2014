...
var remote = {
	...
	CONFIG_PARSE_KEYS: "Config.parseKeys",
	CONFIG_PARSE_OPTIONS: "Config.parseOptions",
	CONFIG_SAVE_KEYS: "Config.saveKeys",
	CONFIG_SAVE_OPTIONS: "Config.saveOptions",
	CONFIG_LOAD_KEYS: "Config.loadKeys",
	CONFIG_LOAD_OPTIONS: "Config.loadOptions",
	CONFIG_EACH_OPTION: "Config.eachOption",
	CONFIG_KEYMAP: "Config.keyMap",
	CONFIG_OPTIONS: "Config.options",
	CONTROL_PREVENT_DEFAULT: "Control.preventDefault",
	INPUT_GAMEPADS: "Input.gamepads",
	...
	ENGINE_ONCE: "Engine.once",
	ENGINE_ON: "Engine.on",
	ENGINE_OFF: "Engine.removeListener",
	SYSTEM_ON: "System.on",
...
var local = {
	...
	Command: {
		...
		COMMAND_ON: "event.on",
		COMMAND_OFF: "event.removeListener",
	...
	Control: {
		...
		CONTROL_ON: "event.on",
		CONTROL_OFF: "event.removeListener",
	...
	Config: {
		...
		CONFIG_PARSE_KEYS: "parseKeyMap",
		CONFIG_SAVE_KEYS: "saveKeyMap",
		CONFIG_LOAD_KEYS: "loadKeyMap",
		CONFIG_PARSE_OPTIONS: "parseOptions",
		CONFIG_SAVE_OPTIONS: "saveOptions",
		CONFIG_LOAD_OPTIONS: "loadOptions",
		CONFIG_EACH_OPTION: "forEachOption",
		CONFIG_KEYMAP: "defaultControls",
		CONFIG_OPTIONS: "defaultOptionsObject"
	},
	GUI: {
	...
	Input: {
		INPUT_GAMEPADS: "gamepads"
	},
	IO: {
		IO_READ: "readFile",
		IO_WRITE: "writeFile",
		IO_REQUIRE: "requireFile"
	},
	Light: {
	...
	Loop: {
		LOOP_GO: "go",
		LOOP_EVERY: "event.on",
		LOOP_REMOVE: "event.removeListener",
		LOOP_QUEUE: "queue"
	},
	Options: {
	...
	System: {
		...
		SYSTEM_ON: "event.on",
		SYSTEM_OFF: "event.removeListener"
	},
	Engine: {
		ENGINE_ONCE: "event.once",
		ENGINE_ON: "event.on",
		ENGINE_OFF: "event.off"
	},
	Time: {
		TIME_NOW: "nowTime",
		TIME_MICRO: "micro"
...
module.exports = {
	...
	badHTMLFiles: ["WebWorker.js", ".html", ".json", "config.js", "keymap.js"]
};